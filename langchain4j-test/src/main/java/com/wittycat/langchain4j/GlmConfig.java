...
/**
 * GLM 配置加载:全部示例共用,约定与 agentscope-test / langgraph4j-test / ai-agent 完全一致。
 *
 * 【知识点】
 * 1. 智谱 GLM 开放平台提供 OpenAI 兼容协议,所以 LangChain4j 侧不需要任何智谱专用 SDK,
 *    直接用 langchain4j-open-ai(见 GlmModels),换 DeepSeek/Kimi/本地 vLLM
 ...
 *    和 Web 示例(走 Spring 的 application.yml)共享同一份配置文件。
 */
